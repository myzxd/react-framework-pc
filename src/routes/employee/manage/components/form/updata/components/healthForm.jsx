    ...
    const formItems = [
      {
        ...
        form: getFieldDecorator('healthPaperworkType', {
          initialValue: initHealthPaperworkType ? `${initHealthPaperworkType}` : undefined,
        })(
