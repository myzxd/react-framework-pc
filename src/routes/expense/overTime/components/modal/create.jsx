...
class Create extends Component {
  ...
  onSubmit = () => {
    ...
    form.validateFields((err, value) => {
      ...
      const params = {
        ...
        approvalType: OaApplicationOrderType.overTime, // 加班申请
  ...
  onSuccessCallback = (res) => {
    if (res && res._id) {
      window.location.href = `/#/Expense/Attendance/OverTime/Create?applicationOrderId=${res._id}`;
    }
  }
  ...
  renderFlowNodes = () => {
    ...
    if (nodeList.length === 0 || !flowId) return '';
