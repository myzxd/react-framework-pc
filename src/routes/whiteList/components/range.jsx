 ...
 class ApplyRange extends Component {
   ...
   onChange = (type, value, selectorAll = false, spell = []) => {
     ...
     if (type === selector.supplier) {
       ...
       if (selectorAll) {
         onChangeSelectAll(1);
         form.setFieldsValue({ supplier: '全部', city: '全部', districtsArray: '全部', choiceCity: '全部', choiceDistrict: '全部' });
         this.setState({
           supplierInput: 'all',
           cityInput: 'all',
           districtInput: 'all',
     ...
     if (type === selector.city) {
       ...
       if (selectorAll) {
         onChangeSelectAll(2);
         form.setFieldsValue({ city: '全部', districtsArray: '全部', choiceCity: '全部', choiceDistrict: '全部' });
         this.setState({
           cityInput: 'all',
           districtInput: 'all',
           citiesAll: true,
     ...
     if (type === selector.district) {
       ...
       if (selectorAll) {
         onChangeSelectAll(3);
         form.setFieldsValue({ districtsArray: '全部', choiceDistrict: '全部' });
         this.setState({
           districtInput: 'all',
           districtsAll: true,
         });
   ...
   render() {
     ...
     const formItems = [
       {
         label: '平台',
         form: form.getFieldDecorator('choice-terrace', {
           rules: [{
             required: true,
             message: '请选择平台',
           }],
       ...
       {
         label: '供应商',
         form: form.getFieldDecorator('choiceSuppliers', {
           rules: [{
             required: true,
             message: '请选择供应商',
           }],
         ...
         label: '城市',
         form: form.getFieldDecorator('choiceCity', {
           rules: [{
             required: true,
             message: '请选择城市',
           }],
         ...
         label: '商圈',
         form: form.getFieldDecorator('choiceDistrict', {
           rules: [{
             required: true,
             message: '请选择商圈',
           }],
     ...
     return (
       <CoreContent title="选择白名单应用范围" style={{ backgroundColor: '#FAFAFA' }}>
