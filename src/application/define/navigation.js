...
export default [
  ...
  // 人员管理
  {
    ...
    routes: [
      ...
      // 合同归属管理
      {
        ...
        relative: [
          { module: Modules.ModuleSystemManageCompanyDetail },
          { module: Modules.ModuleSystemManageCompanyUpdate },
        ],
      },
      // 推荐公司管理
      {
    ...
    routes: [
      {
        ...
        routes: [
          ...
          // 付款规则
          { module: Modules.ModuleCodePaymentRule },
        ],
      },
    ...
    routes: [
      // 基础设置
      {
        ...
        routes: [
          ...
          // 关联审批流
          {
            module: Modules.ModuleExpenseRelationExamineFlow,
            relative: [
              // code/team审批流 - 详情
              { module: Modules.ModuleExpenseRelationExamineFlowCodeTeamDetail },
              // code/team审批流 - 创建
              { module: Modules.ModuleExpenseRelationExamineFlowCodeTeamCreate },
              // code/team审批流 - 编辑
              { module: Modules.ModuleExpenseRelationExamineFlowCodeTeamUpdate },
              // 事务审批流 - 详情
              { module: Modules.ModuleExpenseRelationExamineFlowAffairDetail },
              // 事务审批流 - 创建
              { module: Modules.ModuleExpenseRelationExamineFlowAffairCreate },
              // 事务审批流 - 编辑
              { module: Modules.ModuleExpenseRelationExamineFlowAffairUpdate },
              // 成本类审批流 - 详情
              { module: Modules.ModuleExpenseRelationExamineFlowCostDetail },
              // 成本类审批流 - 创建
              { module: Modules.ModuleExpenseRelationExamineFlowCostCreate },
              // 成本类审批流 - 编辑
              { module: Modules.ModuleExpenseRelationExamineFlowCostUpdate },
              // 非成本类审批流 - 详情
              { module: Modules.ModuleExpenseRelationExamineFlowNoCostDetail },
              // 非成本类审批流 - 创建
              { module: Modules.ModuleExpenseRelationExamineFlowNoCostCreate },
              // 非成本类审批流 - 编辑
              { module: Modules.ModuleExpenseRelationExamineFlowNoCostUpdate },
            ],
          },
      ...
      // 审批中心
      {
        module: Modules.MenuExpenseOrderManage,
        routes: [
          // 事物审批管理
          {
            module: Modules.ModuleOADocumentManage,
            relative: [
              // 还款管理
              {
          ...
          // 事务审批
          { module: Modules.ModuleExpenseManageOAOrder },
          // 费用记录明细
          {
  ...
  // 系统管理
  {
    ...
    routes: [
      ...
      // 合同模版管理
      {
        module: Modules.ModuleSystemContractTemplate,
        relative: [
          // 组件详情
          { module: Modules.ModuleSystemContractTemplateComponentDetail },
        ],
      },
      ...
      // 服务商配置
      {
       ...
       // 审批配置
      { module: Modules.ModuleSystemApproalConfig },
      // 企业付款
      {
